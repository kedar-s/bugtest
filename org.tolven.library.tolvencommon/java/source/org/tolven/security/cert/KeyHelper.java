...
public class KeyHelper {
    ...
    private class X509CertificatePrivateKeyPair {
        ...
        public KeyStore createPKCS12KeyStore(String alias, char[] password) {
            ...
            try {
                KeyStore keyStore = KeyStore.getInstance(KeyHelper.TOLVEN_CREDENTIAL_FORMAT_PKCS12);
                try {
    ...
    public static final String SESSION_SECRET_KEY_ALGORITHM = "AES";
    public static final String SESSION_SECRET_KEY_ALGORITHM_PROP = "AES";
    public static final String SESSION_SECRETY_KEY_LENGTH = "128";
    public static final String SESSION_SECRETY_KEY_LENGTH_PROP = "128";
    ...
    public static SecretKey generateSessionSecretKey() {
        //TODO These should be properties, which are normally in TolvenProperties, but that won't work for gatekeeper?
        String algorithm = SESSION_SECRET_KEY_ALGORITHM;
        int kbeKeyLength = Integer.parseInt(SESSION_SECRETY_KEY_LENGTH);
    ...
    private static CertificateFactory getCertificateFactory() {
        ...
        if (certificateFactory == null)
            try {
                ...
                throw new RuntimeException("Could not get X.509 instance", ex);
            }
    ...
    public static X509Certificate getX509Certificate(byte[] bytes) {
        ...
        try {
            ...
            try {
                x509Certificate = (X509Certificate) getCertificateFactory().generateCertificate(bis);
    ...
    public void createCredentials(TolvenPerson tolvenPerson, char[] userPassword) {
        ...
        byte[] userPKCS12 = KeyHelper.toByteArray(keyStore, userPassword);
