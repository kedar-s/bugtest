...
/*	public String generatePQRI() throws IOException {		
		setMenuPath("echr:admin:hcqmresults:all");
		setSelectedColumnHeadings(getPqriColumnHeadings());
		Writer out = new FileWriter("/home/paul/data-extract.csv"); 
		dq.setLimit(-1);
		getDataExtractBean().streamResultsCSV(out, dq);		
		out.close();
		return "success";
