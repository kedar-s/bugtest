...
/**
 * This plugin starts the plugin deployers
 * 
 * @author Joseph Isaac
 *
 */
public class Deploy extends TolvenCommandPlugin {

    public static final String EXTENSIONPOINT_EXECUTE = "execute";

    private Logger logger = Logger.getLogger(Deploy.class);
