...
public class InvitationQueueBean implements InvitationQueueLocal {
    ...
    public String getQueueName() {
        if (queueName == null) {
            try {
                queueName = invitationQueue.getQueueName();
    ...
    public void send(List<Serializable> payloads) {
        ...
        try {
            ...
            MessageProducer messageProducer = session.createProducer(invitationQueue);
