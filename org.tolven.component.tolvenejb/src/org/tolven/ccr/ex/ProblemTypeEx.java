 ...
 *
 * @author Kul Bhushan
 * @version $Id: ProblemTypeEx.java,v 1.2 2009/05/19 18:29:20 jchurin Exp $
 */
...
public class ProblemTypeEx extends ProblemType{

	public final static String DATE_OF_ONSET = "Onset";
	public final static String PROBLEM_TYPE = "Problem";
	public final static String CONDITION_TYPE = "Condition";
	public final static String DIAGNOSIS_TYPE = "Diagnosis";
	public final static String SYMPTOM_TYPE = "Symptom";
	public final static String FINDING_TYPE = "Finding";
	public final static String COMPLAINT_TYPE = "Complaint";
	public final static String FUNCTIONAL_LIMITATION_TYPE = "Functional Limitation";
