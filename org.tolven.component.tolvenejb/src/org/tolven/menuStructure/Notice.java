 ...
 *         &lt;element name="body" type="{urn:tolven-org:menuStructure:1.0}InvitationBody" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    implements Serializable
{
    ...
    protected List<InvitationBody> bodies;
    @XmlAttribute
     ...
     * 
     */
    public List<InvitationBody> getBodies() {
        if (bodies == null) {
            bodies = new ArrayList<InvitationBody>();
        }
        return this.bodies;
    }
