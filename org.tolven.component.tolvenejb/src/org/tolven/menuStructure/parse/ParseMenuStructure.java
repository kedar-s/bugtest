...
public class ParseMenuStructure extends ParseXML {
	...
	/**
	 * Given a String, parse the contents of the string into an Application object
	 * @param input to parse
	 * @return The resulting Application object
	 * @throws JAXBException
	 */
	public Application parseString( String input ) throws JAXBException {
		Application application = (Application)getUnmarshaller().unmarshal( new StreamSource( new StringReader( input ) ) );
		return application;
	}
