...
public interface AccountDAOLocal {
    ...
    /**
     ...
     public boolean addSystemUserToAccount(AccountUser accountUser,PrivateKey userPrivateKey);
      ...
      */
      ...
      public List<AccountType> findActiveAccountTypes ( );
         ...
         * @param user
         */
        public void setupAccountKeys(Account account, AccountUser accountUser, AccountPrivateKey accountPrivateKey, TolvenUser user, PublicKey userPublicKey);
