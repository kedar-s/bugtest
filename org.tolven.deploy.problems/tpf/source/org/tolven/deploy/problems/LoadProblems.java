...
public class LoadProblems extends LoadRESTfulClient {
    String fileName;
    ...
    public LoadProblems(String userId, char[] password, String appRestfulURL, String authRestfulURL) {
        init(userId, password, appRestfulURL, authRestfulURL);
    }

    public String generateName(String fields[]) {
        return "problem/SCTID-" + fields[SCTID];
    }
    ...
    public void generateTrim(String fields[], XMLStreamWriter writer) throws XMLStreamException {
        ...
        writer.writeCharacters("obs/evn/problem");
    ...
    public void load(String fileName) throws Exception {
        TolvenLogger.info("Uploading UMLS problem list from: " + fileName, LoadProblems.class);
        try {
            ...
            while (reader.ready()) {
                ...
                if (rowCount > getIterationLimit()) {
                    TolvenLogger.info("Upload stopped early due to " + UPLOAD_LIMIT + " property being set", LoadProblems.class);
                    break;
                }
            ...
            TolvenLogger.info("Count of Problems uploaded: " + (rowCount - 1), LoadProblems.class);
            TolvenLogger.info("Activating headers... ", LoadProblems.class);
            activate();
        } finally {
            logout();
        }
    ...
    */
    ...
    public static void main(String[] args) throws Exception {
        ...
        //LoadProblems ld = new LoadProblems(args[0]);
