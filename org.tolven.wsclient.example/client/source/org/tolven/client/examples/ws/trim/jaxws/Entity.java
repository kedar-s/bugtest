    ...
    extends InfrastructureRoot
{
    ...
    protected List<Role> playedRole;
    @XmlElement(nillable = true)
    protected List<Role> scopedRole;
    @XmlElement(nillable = true)
    ...
    /**
     * Gets the value of the playedRole property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the playedRole property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPlayedRole().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Role> getPlayedRole() {
        if (playedRole == null) {
            playedRole = new ArrayList<Role>();
        }
        return this.playedRole;
    }

    /**
     * Gets the value of the scopedRole property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the scopedRole property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getScopedRole().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Role> getScopedRole() {
        if (scopedRole == null) {
            scopedRole = new ArrayList<Role>();
        }
