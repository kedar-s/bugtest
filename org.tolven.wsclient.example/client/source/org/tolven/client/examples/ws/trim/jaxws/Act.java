 ...
 *       &lt;attribute name="levelCode" type="{http://www.w3.org/2001/XMLSchema}string" />
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
    ...
    extends InfrastructureRoot
{
    ...
    protected List<ActParticipation> participation;
    protected List<ActRelationship> relationship;
    protected List<Compute> compute;
    @XmlAttribute(name = "classCode", required = true)
    protected ActClass classCode;
    @XmlAttribute(name = "moodCode", required = true)
    protected ActMood moodCode;
    @XmlAttribute(name = "levelCode")
     ...
     * 
     */
    public List<Party> getSendTo() {
        if (sendTo == null) {
            sendTo = new ArrayList<Party>();
        }
        return this.sendTo;
    }
     ...
     * 
     */
    public List<ActParticipation> getParticipation() {
        if (participation == null) {
            participation = new ArrayList<ActParticipation>();
        }
     ...
     * 
     */
    public List<ActRelationship> getRelationship() {
        if (relationship == null) {
            relationship = new ArrayList<ActRelationship>();
        }
