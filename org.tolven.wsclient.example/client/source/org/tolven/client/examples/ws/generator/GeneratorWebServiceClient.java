...
public class GeneratorWebServiceClient {
     ...
     * 
     * java -Djavax.net.ssl.keyStore=keyStoreFile -Djavax.net.ssl.trustStore=trustStoreFile org.tolven.client.examples.ws.generator.GeneratorWebServiceClient http://dev.able.com:8080/ws/generator?wsdl
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 2) {
            System.out.println("Usage: java -Djavax.net.ssl.keyStore=keyStoreFile -Djavax.net.ssl.keyStorePassword=tolven -Djavax.net.ssl.trustStore=trustStoreFile org.tolven.client.examples.ws.generator.GeneratorWebServiceClient https://dev.able.com:8443/ws/generator?wsdl outFile");
            System.exit(1);
        }
        ...
        GeneratorWebServiceClient client = new GeneratorWebServiceClient(username, password, wsdl, 60);
        Generator port = client.getGeneratorPort();
        client.generate(outFile);
        port.logout();
