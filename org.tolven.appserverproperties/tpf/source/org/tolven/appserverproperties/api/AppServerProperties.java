...
public class AppServerProperties {
    ...
    public AppServerProperties(String userId, char[] password) {
        setLoadServerProperties(new LoadServerProperties(userId, password));
    }
    ...
    public String findProperty(String propertyName) {
        try {
            ...
            throw new RuntimeException("Could not find property: " + propertyName, ex);
        } finally {
            getLoadServerProperties().logout();
        }
    }
    ...
    public void removeProperty(String propertyName) {
        try {
            ...
            throw new RuntimeException("Could not remove property: " + propertyName, ex);
        } finally {
            getLoadServerProperties().logout();
        }
    }
    ...
    public void setProperties(Properties properties) {
        try {
            getLoadServerProperties().setProperties(properties);
        } catch (Exception ex) {
            throw new RuntimeException("Could not set properties: ", ex);
        } finally {
            getLoadServerProperties().logout();
        }
    }
    ...
    public void setProperty(String propertyName, String propertyValue) {
        try {
            ...
            throw new RuntimeException("Could not set property: " + propertyName, ex);
        } finally {
            getLoadServerProperties().logout();
        }
    }
