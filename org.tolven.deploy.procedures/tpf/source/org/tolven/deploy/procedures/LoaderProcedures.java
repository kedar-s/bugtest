...
public class LoaderProcedures extends TolvenCommandPlugin {
    ...
    public void execute(String[] args) throws Exception {
        ...
        LoadProcedures loader = new LoadProcedures(getAdminId(), getAdminPassword(), getAppRestfulRootURL(), getAuthRestfulRootURL());
        File src = getFilePath("tpf/voc/procedures.txt");
