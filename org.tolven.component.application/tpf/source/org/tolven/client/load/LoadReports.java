...
public class LoadReports extends RESTfulClient {
    ...
    public void uploadJRXML(File file) {
        ...
        ClientResponse response = webResource.queryParam("externalReportName", baseFilenameWithNoExt).queryParam("reportType", "jrxml").type(MediaType.APPLICATION_XML).cookie(getTokenCookie()).entity(xml).post(ClientResponse.class);
