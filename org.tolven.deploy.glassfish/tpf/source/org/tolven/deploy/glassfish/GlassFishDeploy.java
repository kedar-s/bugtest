 ...
 * @version $Id$
 */
package org.tolven.deploy.glassfish;
 ...
 *
 */
public class GlassFishDeploy extends TolvenCommandPlugin {
    ...
    private Logger logger = Logger.getLogger(GlassFishDeploy.class);
