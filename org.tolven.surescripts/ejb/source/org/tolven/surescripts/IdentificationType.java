 ...
 *       &lt;choice maxOccurs="3">
 *         &lt;element name="NCPDPID" type="{http://www.surescripts.com/messaging}an..35" minOccurs="0"/>
 ...
 *         &lt;element name="ProviderUID" type="{http://www.surescripts.com/messaging}an..6M" minOccurs="0"/>
...
public class IdentificationType implements Serializable{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "ProviderUID", namespace = "http://www.surescripts.com/messaging", type = JAXBElement.class),
    ...
    protected List<JAXBElement<String>> ncpdpidOrSPIOrFileID;

    /**
     * Gets the value of the ncpdpidOrSPIOrFileID property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ncpdpidOrSPIOrFileID property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNCPDPIDOrSPIOrFileID().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<String>> getNCPDPIDOrSPIOrFileID() {
        if (ncpdpidOrSPIOrFileID == null) {
            ncpdpidOrSPIOrFileID = new ArrayList<JAXBElement<String>>();
        }
        return this.ncpdpidOrSPIOrFileID;
    }
