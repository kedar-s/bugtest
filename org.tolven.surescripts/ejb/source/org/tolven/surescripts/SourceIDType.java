 ...
 *       &lt;choice maxOccurs="3">
 *         &lt;element name="SPI" type="{http://www.surescripts.com/messaging}an..35M" minOccurs="0"/>
 *         &lt;element name="SDPI" type="{http://www.surescripts.com/messaging}an..35M" minOccurs="0"/>
...
@XmlType(name = "SourceIDType", propOrder = {
    "spiOrSDPIOrMemberNumber"
})
public class SourceIDType implements Serializable{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "SDPI", namespace = "http://www.surescripts.com/messaging", type = JAXBElement.class),
    ...
    protected List<JAXBElement<String>> spiOrSDPIOrMemberNumber;

    /**
     * Gets the value of the spiOrSDPIOrMemberNumber property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the spiOrSDPIOrMemberNumber property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSPIOrSDPIOrMemberNumber().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<String>> getSPIOrSDPIOrMemberNumber() {
        if (spiOrSDPIOrMemberNumber == null) {
            spiOrSDPIOrMemberNumber = new ArrayList<JAXBElement<String>>();
        }
        return this.spiOrSDPIOrMemberNumber;
    }
