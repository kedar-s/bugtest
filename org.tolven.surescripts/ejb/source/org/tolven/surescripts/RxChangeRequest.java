 ...
 *         &lt;element name="Request" type="{http://www.surescripts.com/messaging}RequestType" minOccurs="0"/>
 ...
 *         &lt;element name="MedicationRequested" type="{http://www.surescripts.com/messaging}MedicationType" maxOccurs="9" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RxChangeRequest implements Serializable{
    ...
    protected List<MedicationType> medicationRequested;
     ...
     * 
     */
    public List<MedicationType> getMedicationRequested() {
        if (medicationRequested == null) {
            medicationRequested = new ArrayList<MedicationType>();
        }
