...
/**
 * This plugin outputs an oracle database indexes file
 * 
 * @author Joseph Isaac
 *
 */
public class OracleDBPlugin extends TolvenCommandPlugin {
    ...
    private Logger logger = Logger.getLogger(OracleDBPlugin.class);
    ...
    public void execute(String[] args) {
        ...
        if(commandLine.hasOption(CMD_SCHEMAS)) {
            ...
            logger.info("No schema updates required");
        } else {
