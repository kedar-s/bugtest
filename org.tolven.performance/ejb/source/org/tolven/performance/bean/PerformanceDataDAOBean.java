 ...
 */
package org.tolven.performance.bean;
...
import org.tolven.performance.api.PerformanceDataDAO;
import org.tolven.performance.entity.PerformanceData;
/**
...
public class PerformanceDataDAOBean implements PerformanceDataDAO, Serializable {
	 ...
	 * @param elapsed
	 * @param exceptions
	 * @see org.tolven.performance.api.PerformanceDataDAO#addPerformanceData(Date, String, String, long, String, String, String, long, String)
	 * @return
	 */
	 ...
	 * @see org.tolven.performance.api.PerformanceDataDAO#getPerformanceData()
	 */
	 ...
	 * @param maxLength the maximum length of list to return
	 * 
	 * @see org.tolven.performance.api.PerformanceDataDAO#getAccountUserSummary()
	 */
			...
			if (map.get("filter") != null && !map.get("filter").toString().equals("")){
				...
				for (String filter : filters) {
					...
					if (params[0].equals("date")){
						...
						queryString += " AND trim(p.method) like '" + params[1].toString().trim() + "%'";
					}
				}
			}
