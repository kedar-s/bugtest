 ...
 * @author Joseph Isaac
 */
package org.tolven.gatekeeper.rs.listener;
 ...
 */
@WebListener
public class GatekeeperRSServletContextListener implements ServletContextListener {

    private static String[] shiroRealms = { "tolven,org.tolven.gatekeeper.realm.ldap.TolvenLdapRealm" };
    private static String[] shiroFilters = { "rsauthz,org.tolven.gatekeeper.filter.RSAuthorizationFilter" };

    private Logger logger = Logger.getLogger(GatekeeperRSServletContextListener.class);
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        ...
        logger.info("Module initialized: org.tolven.gatekeeper.rs ContextPath: " + servletContext.getContextPath());
    }
