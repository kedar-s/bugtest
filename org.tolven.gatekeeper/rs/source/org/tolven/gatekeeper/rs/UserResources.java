...
public class UserResources {
    ...
    public Response createTolvenPerson(
        ...
        try {
            ...
            TolvenPerson existingTolvenPerson = getLdapLocal().findTolvenPerson(tolvenPerson.getUid(), realm);
    ...
    public Response findTolvenPerson(
        ...
        try {
            ...
            TolvenPerson tolvenPerson = getLdapLocal().findTolvenPerson(uid, realm);
    ...
    protected LdapLocal getLdapLocal() {
        if (ldapLocal == null) {
            String jndiName = "java:app/gatekeeper-ejb/LdapBean!org.tolven.gatekeeper.LdapLocal";
            try {
