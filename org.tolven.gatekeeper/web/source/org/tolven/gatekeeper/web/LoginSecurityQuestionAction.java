...
public class LoginSecurityQuestionAction {
    ...
    @EJB
    private SecurityQuestionLocal securityQuestionLocal;
    ...
    public String addLoginSecurityQuestions() {
        ...
        if (!securityQuestions.isEmpty()) {
            getSecurityQuestionLocal().addSecurityQuestions(securityQuestions);
        }
        return "success";
    }
    ...
    public List<SecurityQuestion> getCurrentSecurityQuestions() {
        if (currentSecurityQuestions == null) {
            currentSecurityQuestions = (List<SecurityQuestion>) getSecurityQuestionLocal().findSecurityQuestions(SecurityQuestionPurpose.LOGIN_PASSWORD_BACKUP.value());
    ...
    public SecurityQuestionLocal getSecurityQuestionLocal() {
        return securityQuestionLocal;
    }
    ...
    public String removeLoginSecurityQuestions() {
        ...
        if (!questionsToRemove.isEmpty()) {
            getSecurityQuestionLocal().removeSecurityQuestions(questionsToRemove, SecurityQuestionPurpose.LOGIN_PASSWORD_BACKUP.value());
        }
        return "success";
    }
