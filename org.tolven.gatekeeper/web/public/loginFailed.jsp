<%@ page import="org.tolven.session.TolvenSessionWrapperFactory,org.apache.shiro.web.util.SavedRequest,org.apache.shiro.web.util.WebUtils" %>
...
<%
    ...
    */
    ...
    SavedRequest savedRequest = ((SavedRequest) request.getSession(false).getAttribute("shiroSavedRequest"));
    String contextPath = null;
    if(savedRequest == null) {
        contextPath = request.getContextPath();
    } else {
        contextPath = savedRequest.getRequestUrl();
    }
...
<hr/>
<a href="<%=contextPath%>">Return to the <%=contextPath%> login page.</a>
</body>
</html>
