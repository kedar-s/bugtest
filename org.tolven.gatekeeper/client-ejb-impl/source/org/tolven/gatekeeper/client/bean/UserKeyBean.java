 ...
 *
 * @author Joseph Isaac
 * @version $Id: UserKeyBean.java 6483 2012-05-16 00:15:33Z joe.isaac $
 */
...
public class UserKeyBean implements UserKeyLocal {
    ...
    public X509Certificate getUserX509Certificate(String uid, String realm) {
        ...
        ClientResponse response = webResource.queryParam("realm", realm).queryParam("attributes", "userCertificate").get(ClientResponse.class);
