...
import org.tolven.gatekeeper.entity.Property;
 ...
 */
@Stateless
@Local(GatekeeperPropertiesLocal.class)
public class GatekeeperProperties implements GatekeeperPropertiesLocal {
    ...
    class PropertyMap implements Map<String, String> {
        ...
        public boolean containsKey(Object key) {
            throw new UnsupportedOperationException("Property operation not supported in Gatekeeper");
        }
        ...
        /**
         * Put or update a property in this Gatekeeper's list of properties.
         */
        @Override
