...
public class ResourceServlet extends TolvenServlet {
	...
	public static Map<String, FileInfo> cache;
...
//    		TolvenLogger.info( "ResourceServlet: " + path, ResourceServlet.class);
	 ...
	 */
	protected synchronized String getCompressedJSFile(String path, HttpServletRequest request, InputStream in) throws Exception{
		if(cache == null) {
    ...
    protected boolean isJSDebugEnabled(HttpServletRequest request) {
    	String jsDebug = getPropertiesBean().getProperty("tolven.web.javascript.debug");
