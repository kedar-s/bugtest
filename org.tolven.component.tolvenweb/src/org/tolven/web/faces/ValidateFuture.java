 ...
 * Date entered should be a future date, otherwise ValidatorException is thrown 
 */
public class ValidateFuture implements Validator, Serializable {
	...
	public void validate(FacesContext ctx, UIComponent comp, Object value) throws ValidatorException {
		...
		try {
			...
			if(dateEntered!=null && dateEntered.before(now))
