            ...
            if (typeof Timeline_urlPrefix == "string") {
                ...
                for (var h = 0; h < heads.length; h++) {
                    ...
                    for (var s = 0; s < scripts.length; s++) {
                        ...
                        if (i >= 0) {
							//don't need this any more for IE8
                        	//if(Prototype.Browser.IE){
							//url = document.location.protocol + "//" + document.location.hostname +":"+document.location.port+url;
							//}
...
//            includeCssFiles(Timeline.urlPrefix, [ "bundle.css" ]);
        ...
        for (var l = 0; l < supportedLocales.length; l++) {
            ...
            if (loadLocale[locale]) {
                includeJavascriptFiles(Timeline.urlPrefix + "l10n/" + locale + "/", localizedJavascriptFiles);
                includeCssFiles(Timeline.urlPrefix + "l10n/" + locale + "/", localizedCssFiles);
			}
        }
