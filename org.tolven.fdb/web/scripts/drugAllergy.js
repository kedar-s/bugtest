...
//method to select drug allergy from the popup
// when selecting allergy from favorites list the code will also have type appended to it
//@allergen - name of the allergy
//@type - the concept type for the allergy
//@code - fdb conceptcode for the allergs
//@args - arguments passed from the wizard
